...
<body>
    <h1 class="text-center mb-5">Edit Mahasiswa</h1>
                ...
                <div class="card-body">
                    <form action="/updatesiswa/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" name="Nama" class="form-control" id="nama" aria-describedby="namalengkap" value="{{ $data->Nama }}" placeholder="{{ $data->Nama }}">
                        </div>
                        <div class="mb-3">
                          <label for="alamat" class="form-label">Alamat</label>
                          <input type="text" name="Alamat" class="form-control" placeholder="{{ $data->Alamat }}" value="{{ $data->Alamat }}" id="alamat">
                        </div>
                        <div class="mb-4">
